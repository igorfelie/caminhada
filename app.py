...
def process_image(uploaded_image):
    # Caminho da sua imagem base (substitua o caminho conforme necessário)
    base_image = Image.open(r"C:\\Users\\ffsan\\OneDrive\\Área de Trabalho\\caminhada\\editavel.png")  # Caminho completo da imagem base
